...
mongoose.connect("mongodb://localhost:27017", { //Mongoose material
    dbName: "WEBDATA" //Mongoose material
}).then(()=>console.log("Database have been connected")).catch((e)=>console.log(e)); //Mongoose material

const messageSchema = new mongoose.Schema({ //Mongoose material
